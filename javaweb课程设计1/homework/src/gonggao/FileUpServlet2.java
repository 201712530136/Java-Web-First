 ...
 */
@WebServlet("/FileUpServlet2")//改写数据库的功能写好后复制一份改成2
@MultipartConfig
public class FileUpServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FileUpServlet2() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String imagebase = request.getParameter("imagebase1");
		...
		PrintWriter outt=response.getWriter();
		 ...
		 if (imagebase != null) {
		        ...
		        try {
					...
					String sql = "UPDATE activity SET Image2=? WHERE ID= ?";
						try {
