	...
	<div class="about-sec" id="about">
		<div class="container">
			...
			<div class="about-sub">
				...
				<h4></h4>
				<form action="liuyanban4.jsp" method="get"    >
...
if(conn!=null){conn.close();}
      ...
      try {
    	    ...
    	    //创建数据库连接
    	    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/huangshandian?userUnicode=true&&characterEncodeing=utf-8","root","123456");
    	    //创建查询 “请求”
