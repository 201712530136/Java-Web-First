...
<body>
	...
	<div class="blog-cource">
		<div class="container">
			...
			%>
			<div class="">
				<img src=<%=rs.getString("Image1")%> alt="" class="image" border=""
					align="left" height="400" width="400" /> <img
					src=<%=rs.getString("Image2")%> alt="" class="image" border=""
			...
			<div>
				...
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a href="EnterServlet" class="button-style">知道了</a>

				<%
					} else {
				%>

				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a href="EnterServlet" class="button-style">- 报名 -</a>
				<%
					}
				%>
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a
					href="javascript:history.go(-1)" class="button-style">- 返回 -</a>
			</div>
