	...
	<div class="container">
		...
		<div class="blog-info">
				...
				<tr>
					...
					申请职位：<%=rs.getString(7)%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					家庭住址：<%=rs.getString(8)%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
					<a class="button-style" href="user1details.jsp?id=<%=rs.getInt(1)%>">修改</a>
		...
		<div class="title-div">
			<h1>
				<a href="user1.jsp?page=<%=currentpage - 1%>"> << </a>
				<%
					for (int o = 1; o <= totalpage; o++) {
				%>
				<a href="user1.jsp?page=<%=o%>"><%=o%></a>
				<%
					}
				%>
