...
function  getDate01(){
	...
	/** 模糊查询来电用户  **/
	function search(){
		$("#submitForm").attr("action", "book_list.html?page=" + 1).submit();
	}

	/** 新增   **/
	function add(){
		$("#submitForm").attr("action", "book_edit.html").submit();	
	}
...
// 				return;
	...
	function jumpNormalPage(page){
		$("#submitForm").attr("action", "book_list.jsp?page=" + page).submit();
	}
	...
	function jumpInputPage(totalPage){
		...
		if($("#jumpNumTxt").val() != ''){
			...
			$("#submitForm").attr("action", "book_list.jsp?page=" + pageNum).submit();
		}else{
			// “跳转页数”为空
			art.dialog({icon:'error', title:'友情提示', drag:false, resize:false, content:'请输入合适的页数，\n自动为您跳到首页', ok:true,});
			$("#submitForm").attr("action", "book_list.jsp?page=" + 1).submit();
		}
	}
</script>
<style>
		...
		<div id="container">
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_top">
						welcome!!
				<a href="javascript:void(0);" onclick="logout();" target="_parent" style="list-style: none;float: right;" >
					退出系统
				</a> 
				<ul style="list-style: none;float: right;">
					...
					<li style="list-style: none;float:right;">
						...
						<div id="box_center">
						  ...
						  书名   &nbsp;&nbsp;
                          <input type="text" id="fyZldz2" name="fyZldz" class="ui_input_txt02" />
						</div>
						<div id="box_bottom">
			...
			<div class="ui_content">
				...
				<%BookDao bookdao=new  BookDao();
				  ArrayList<Book> booklist=bookdao.bookquery();	
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<tr>
							...
							<%if(booklist!=null&&booklist.size()>0){
								...
								%>
							<tr>
								<td><input type="checkbox" name="IDCheck" value="<%=i+1%>" class="acb" /></td>
								<td><%=book.getISBN()%></td>
								...
								<td><%=book.getDecription() %></td>
								<td>
									<a href="book_update.jsp?isbn=<%=book.getISBN()%>" class="edit">编辑</a> 
				...
				<div class="ui_tb_h30">
					<div class="ui_flt" style="height: 30px; line-height: 30px;">
						共有
						<span class="ui_txt_bold04"><%=totalRecord%></span>
						条记录，当前第
					...
					<div class="ui_frt">
						<!--    如果是第一页，则只显示下一页、尾页 -->
							...
							onclick="jumpNormalPage(<%=currentPage-1%>);"/>
							<input type="button" value="下一页" class="ui_input_btn01"
								onclick="jumpNormalPage(<%=currentPage+1%>);" />
							<input type="button" value="尾页" class="ui_input_btn01"
								onclick="jumpNormalPage(<%=totalPage%>);" />
