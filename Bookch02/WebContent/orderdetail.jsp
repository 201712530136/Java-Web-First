...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
        	...
        	String order_time=sd.format(date);
        	...
        	%>
                ...
                <%if(booklist!=null){
                	...
                	for(int i=0;i<booklist.size();i++){
                		...
                		String sql="insert into orderdetails values(?,?,?,?)";
                         ...
                         ps.setDouble(4, book.getPrice()*book.getCount());
             ...
             String sql1="select * from userdetail where username=?";
             ps=conn.prepareStatement(sql1);
             ps.setString(1, username);
             ResultSet rs=ps.executeQuery();
             String useremail="",telephone="",address="";
             if(rs!=null&&rs.next()){
             ...
             订单号：<%=order_id%>&nbsp;&nbsp;&nbsp;&nbsp;电话：<%=telephone%><br>
              地址：<%=address%><br>
            <a href="index.jsp" class="continue"> 取消订单</a>
            <a href="paymentServlet?order_id=<%=order_id%>" class="checkout">确认付款</a>
             ...
             if(n>0){
            	 out.println("<script>alert('订单生成成功')</script>");
            	 session.setAttribute("payment", totalprice);
             }else{
            	 ...
            	 %> 
            	<font size="10" color="red">请购物</font><br>
			...
			%><div class="languages_box"><%=welcome%></div>
              ...
              <div class="cart">
                 ...
                 <%=count%>个商品 | <span class="red">总价: <%=totalprice%>元</span>
                  ...
                  <a href="ordetail.jsp" class="view_cart">查看订单</a>
